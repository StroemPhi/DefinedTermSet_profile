...
slots.primary_email = Slot(uri=SCHEMA.email, name="primary_email", curie=SCHEMA.curie('email'),
                   model_uri=DEFINEDTERMSET_PROFILE.primary_email, domain=None, range=Optional[str])

slots.birth_date = Slot(uri=SCHEMA.birthDate, name="birth_date", curie=SCHEMA.curie('birthDate'),
                   model_uri=DEFINEDTERMSET_PROFILE.birth_date, domain=None, range=Optional[Union[str, XSDDate]])

slots.age_in_years = Slot(uri=DEFINEDTERMSET_PROFILE.age_in_years, name="age_in_years", curie=DEFINEDTERMSET_PROFILE.curie('age_in_years'),
                   model_uri=DEFINEDTERMSET_PROFILE.age_in_years, domain=None, range=Optional[int])

slots.vital_status = Slot(uri=DEFINEDTERMSET_PROFILE.vital_status, name="vital_status", curie=DEFINEDTERMSET_PROFILE.curie('vital_status'),
                   model_uri=DEFINEDTERMSET_PROFILE.vital_status, domain=None, range=Optional[Union[str, "PersonStatus"]])
...
slots.Person_primary_email = Slot(uri=SCHEMA.email, name="Person_primary_email", curie=SCHEMA.curie('email'),
                   model_uri=DEFINEDTERMSET_PROFILE.Person_primary_email, domain=Person, range=Optional[str],
