# Contributing to DefinedTerm_profile

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
DefinedTerm_profile. These guidelines are not strict rules.
...
The DefinedTerm_profile team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the DefinedTerm_profile technical leads
...
[issues]: https://github.com/StroemPhi/DefinedTerm_profile/issues/
[pulls]: https://github.com/StroemPhi/DefinedTerm_profile/pulls/
