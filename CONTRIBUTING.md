# Contributing to DefinedTermSet_profile

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
DefinedTermSet_profile. These guidelines are not strict rules.
...
The DefinedTermSet_profile team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the DefinedTermSet_profile technical leads
...
[issues]: https://github.com/stroemphi/DefinedTermSet_profile/issues/
[pulls]: https://github.com/stroemphi/DefinedTermSet_profile/pulls/
